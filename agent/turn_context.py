...
def build_turn_context(
    ...
    # The delegated Codex path sends this same composition as its current input;
    # recovery envelopes are observed separately at the runtime dispatch boundary.
    # MoA appends per-call aggregate context after this point, so its wire bytes are
    # not stable enough to stamp here.
    if (
        not moa_active
