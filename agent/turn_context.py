...
def build_turn_context(
    ...
    *,
    ...
    # exactly the bytes the loop sends. The delegated Codex path sends the
    # same composition as its current input; recovery envelopes are observed
    # separately at the runtime dispatch boundary.
